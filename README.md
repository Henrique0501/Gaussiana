# Gaussiana
programa Gaussiana plota um histograma com base em dados de uma tabela do Excel e realiza um ajuste segundo a equação de uma gaussiana, fornecendo os parâmetros de ajuste. 
